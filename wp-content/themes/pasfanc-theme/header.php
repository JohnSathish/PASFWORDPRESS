...
<div id="page" class="site">
			...
			<div class="top-bar-left">
				<?php if ( $top_email ) : ?>
					<a href="mailto:<?php echo esc_attr( sanitize_email( $top_email ) ); ?>" class="top-bar-contact" title="<?php echo esc_attr( $top_email ); ?>">
						...
						<span><?php esc_html_e( 'Email', 'pasfanc-theme' ); ?></span>
					</a>
				<?php endif; ?>
				<?php if ( $top_phone ) : ?>
					...
					<a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $top_phone ) ); ?>" class="top-bar-contact" title="<?php echo esc_attr( $top_phone ); ?>">
						...
						<span><?php esc_html_e( 'Call', 'pasfanc-theme' ); ?></span>
					</a>
				<?php endif; ?>
			</div>
		</div>
	...
	<!-- Branding Banner: Logo center, name, subtitle, quick access -->
		...
		<div class="container branding-inner">
			<div class="branding-main">
				...
				<div class="branding-info">
					...
					$college_subtitle = trim( $college_grant . ' ' . $college_affil );
					?>
					<h1 class="college-name"><?php echo esc_html( $college_name ); ?></h1>
					<?php if ( $college_subtitle ) : ?>
					<p class="college-subtitle"><?php echo esc_html( $college_subtitle ); ?></p>
					<?php endif; ?>
				</div>
			</div>
			<div class="branding-quick-access">
